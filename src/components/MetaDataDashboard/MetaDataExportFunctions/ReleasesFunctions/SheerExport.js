...
class SheerExport extends React.Component {
   constructor(props) {
     super(props)
   }
   state = {
   ...
   sheerExport = () => {
    ...
    // --------------------------------------------------------------------------------------------------
        ...
        let wavRow = [
          ...
          composerArray[1] ? 'Y' : '',
          // Composer 2 Capacity
          composerArray[1] ? this.isPublicDomain(row) ? 'AR' : 'CA' : '',
          // Composer 2 Share
          ...
          composerArray[2] ? 'Y' : '',
          // Composer 3 Capacity
          composerArray[2] ? this.isPublicDomain(row) ? 'AR' : 'CA' : '',
          // Composer 3 Share
          ...
          composerArray[3] ? 'Y' : '',
          // Composer 4 Capacity
          composerArray[3] ? this.isPublicDomain(row) ? 'AR' : 'CA' : '',
          // Composer 4 Share
          ...
          composerArray[4] ? 'Y' : '',
          // Composer 5 Capacity
          composerArray[4] ? this.isPublicDomain(row) ? 'AR' : 'CA' : '',
          // Composer 5 Share
          ...
          composerArray[5] ? 'Y' : '',
          // Composer 6 Capacity
          composerArray[5] ? this.isPublicDomain(row) ? 'AR' : 'CA' : '',
          // Composer 6 Share
      ...
      () => { // done()
        ...
        this.props.downloadCompletedChecker();
        exportTools.generateDownload(this.state.csvData.join('\n'), `DLM_${this.props.releaseFilter.label + "_"}SHEER_EXPORT_${moment().format('YYYY.MM.DD-HH_mm_ss')}.xls`);
      })
    }
